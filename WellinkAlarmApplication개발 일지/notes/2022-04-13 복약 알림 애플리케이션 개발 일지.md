...
modified: '2022-05-09T06:42:07.430Z'
---
...
2022-05-04 복약 알림 애플리케이션 개발 일지

1. 달력 테두리 보이기 (완료)

2. 이전 날짜에 테두리 없애기 (완료)

2022-05-09 복약 알림 애플리케이션 개발 일지


1. 처음 달력에서는 오늘 날짜에 테두리 뜨도록 구현 필요

2. 스와이프 시 화면 전환 구현 필요 
  - OnTouchListener와 GestureListener를 이용해서 구현 실패
  - Fragment에서는 작동하지 않는 듯 함
  - recyclerView에 내장된 기능 찾기
