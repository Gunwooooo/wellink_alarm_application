...
import com.hanait.wellinkalarmapplication.manual.*

class MainViewPagerFragmentAdapter(fragmentActivity: FragmentActivity) : FragmentStateAdapter(fragmentActivity) {

    // 1. ViewPager2에 연결할 Fragment 들을 생성
    private val fragmentList = listOf(ManualFragment1(), ManualFragment2(), ManualFragment3(), ManualFragment4(), ManualFragment5())
